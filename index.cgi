...
<meta name="date" content="2019-01-05T16:04:09-0700" />
...
print("""</p>\n<input type="hidden" name="quote" value="%s">
...
<p class="status vevent vcard">Short link to this quiz: <a rel="me" class="url" href="http://is.gd/sarah_palin_quiz">http://is.gd/sarah_palin_quiz</a>. <a rel="me author" class="url location" href="#">This web page</a> is copyright © 2016&nbsp;19 by <a rel="me" class="vcard fn url" href="/~patrick/">Patrick Mooney</a>. <span class="summary"><a class="url" href="#">This HTML file</a> was last updated</span> on <abbr class="dtstart" title="2019-01-05">the 124th anniversary of the sentencing of Alfred Dreyfus</abbr> (<span class="description">last change: minor cosmetic changes</span>).</p>
</footer>
</div></body>
</html>""")
