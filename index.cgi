...
<meta name="date" content="2016-01-28T15:12:08-0800" />
...
print("""<footer>
<p>More information about this quiz is <a href="technical.html">here</a>. The list of speeches used in this quiz is <a rel="me" href="speech-list.cgi">here</a>. The code generating the quiz and the speech texts that the quiz is based on are available <a rel="me" href="https://github.com/patrick-brian-mooney/sarah-palin-quotes">here</a>. If you know of a reliable transcript of a Sarah Palin speech that this site should use, please reach me <a rel="me" href="https://gnusocial.no/p">on GNUsocial</a> or <a rel="me" href="http://twitter.com/patrick_mooney">on Twitter</a> or <a rel="me" href="http://patrickbrianmooney.nfshost.com/~patrick/personal.html#other-web">elsewhere online</a>.</p>
<p class="status vevent vcard"><a rel="me author" class="url location" href="#">This web page</a> is copyright © 2016 by <span class="fn">Patrick Mooney</span>. <abbr class="summary description" title="'Sara Palin Quote, or Random Algorithmic Gibberish?' last updated">Last update to this HTML file</abbr>: <abbr class="dtstart" title="2016-01-28">28 January 2016</abbr>.</p>
</footer>
</div></body>
</html>""")
