...
import base64, glob, random, re, cgi, html, pprint
from sentence_generator import *       # https://github.com/patrick-brian-mooney/markov-sentence-generator

debugging = True

def encrypt(key, plaintext):
    """Obfuscation, not encryption. From http://stackoverflow.com/a/21754610/5562328"""
    cipher = XOR.new(key)
...
<meta name="date" content="2016-01-27T18:49:27-0800" />
...
params = '%08d%s%s' % (len(the_quote), the_quote, quote_loc)
